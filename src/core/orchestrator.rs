...
use crate::processors::CodeAnalyzer;
...
pub struct AstSummary {
    ...
    pub syntax_errors: Vec<crate::processors::SyntaxError>,
}
...
/// Web scraping / crawling request â€” received via REST API.
...
impl UnifiedProcessor {
    ...
    pub async fn extract_and_store_relationships(&self, chunks: &[crate::core::chunking::Chunk], source_id: &str, user_id: &str) -> Result<()> {
        ...
        // â”€â”€ Step 2.5: Cross-file Symbol Resolution (formerly 2.75) â”€â”€
